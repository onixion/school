...
Expressionisten sind die Elite, sie stehen über dem Durchschnitt. Sie verachten die Väterschaft, sie geben die Schuld den Vätern. Mütter sind nicht schuld, da diese nicht viele Rechte gehabt haben. 
Man sucht alternative Lebensformen und sucht das einfache Leben in exotischen Ländern. Ohne Zwänge, ohne von der Wirtschaft geknechtet zu werden. Es geht vorwiegend um die Gefühle. Aussehen ist nicht so wichtig, sondern die Darstellung von Gefühlen und Charakter.

Der Krieg wurde als Kunstwerk gesehen, aber als der Krieg beginnt, werden die Grausamkeiten sichtbar und der Krieg zieht sich negativen Ruf auf.
Sexualität wird angesprochen und ist wichtig. Die älteren Menschen (autorithären) werden ins negative gezogen.

1912 wird das Futuristische Manifest (Manirenetti) proklamiert eine neue Sprache. Alles OBerflächliche ist aktuell, also sagen sie die Sprache ist verbraucht. Neue Forderungen in der Sprache. 

1.) Adverbien und Adjektive sind überflüssig
2.) Neue Verben, um die Dynamik zu erhalten
3.) keine Satzzeichen
4.) die Sprache muss expressionsiert werden, keinen Syntax mehr, Satzaufbau zerstört


Der Expressionismus kommt von der Malerei z.B. Künstlervereinigung die Brücke und die Vereinigung des blauen Reiters (München).

Die führenden Maler sind Kirchner und Kandinsky. Die Vereigungen benennen sich nach Werken.

Expressinismus möchte das Äußter aufbrechen, um das Innere sichtbar zu machen. Gewaltakt. Portraie steht im Vordergrund.
...
\begin{itemize}
\item Georg Trakl (Lyriker) wird wahnsinnig vom Krieg, er dient dem Krieg als Sanitäter. 
...
Arthur Schitzler : Leutnant Gustl (Novele) Erzählform: Ich ; inneren Monolog verfasst
