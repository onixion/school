...
Mit der Lyrik ist die liedhafte Dichtung gemeint, die meistens stropfenförmig aufgebaut ist. Sie kann auf zwei verschiedene Möglichkeiten gereimt sein:
	\begin{itemize}
	\item Stabreim: gleicher Anlaut z.B. Mann und Maus
	\item Endreim: Gleichklang ab der letzten betonten Silbe
	\end{itemize}
...
\subsubsection{Dokumentartheater}

Diese Theaterform befasst sich im wesentlichen mit wahren Fakten, historischen Ereignissen und politische Ereignisse. Dabei muss der Autor genauestens recherchieren und gegeben falls auf Protokolle, Bücher, Zeugen oder anderen Informationsquellen zurückgreifen. Es wird versucht unwichtige Informationen wegzulassen. Keine Veränderungen der recherchierten Informationen. Ziel des Autors ist das Stück 'aufführbar' zu machen.

\begin{itemize}
\item \textbf{Der Stellvertreter (1963)} von Rolf Hochkuth: Papst Pios XII während der Nachkriegszeit, die Menschen beschuldigen den Papst nichts getan zu haben
\item \textbf{In der Sache J.R. Oppenheimer (1964)} von Heinar Kipphardt: J. Robert Oppenheimer, einer der Väter der Atombombe, wird von einem Untersuchungsbeschluss gezwungen sich für die verdächtige Gesinnung zu rechtfertigen. Er gerät in Konflikt mit dem Staat.
\item \textbf{Die Ermittlung (1965)} von Peter Weiss: Ausschwitz Prozess, Gerichtsverhandlung der KZ-Leiter, Aufteilung in 11 Gesängen ('Oratorium'), die Beklagten werden mit Namen angesprochen, Zeugen wurden nicht alle im Stück aufgenommen (nur 9)
\end{itemize}

\subsubsection{Epische Theater}

\underline{Bertolt Brecht entwickelt das Epische Theater, um folgendes zu erreichen:}

\begin{itemize}
\item einen aktiv mitdenkenden Zuschauer
\item den Zuschauer dazu bringen nicht die gleichen Fehler wie im Theaterstück zu machen $\rightarrow$ Lehren aus dem Stück ziehen
\end{itemize}

\underline{Dies bewerkstelligt er durch:}

\begin{itemize}
\item V-Effekte: Verfremdungseffekte = Bühnenbild so verändern, dass der Zuschauer immer weiß das er im Theater sitzt
\item der Erzähler klärt den Zuschauer, schon bevor die Szene beginnt, über die wichtigsten Ereignisse auf $\rightarrow$ Ziel ist die Entfernung der Spannung des Zuschauers
\end{itemize}

\subsubsection{Volksstück}

\underline{Merkmale:}

\begin{itemize}
\item Volk konnte mitspielen
\item keine Fallhöhe
\item Musik wurde eingebaut
\item Dialekt wurde verwendet
\item Märchenhafte Einschübe
\end{itemize}

\underline{Nennesswerte Werke:}

\begin{itemize}
\item \textbf{Der Bauer als Millionär} von Ferdinand Raimund
\item \textbf{Das liederliche Kleeblatt} von Johann Nestroy
\end{itemize}
...
\underline{Epische Texte sind gekennzeichnet durch:}
	...
	\begin{itemize}
	\item Inhalt: äußeres Gerüst einer Geschichte (Handlungsverlauf und Figurenkonstellation; Inhaltsangabe)
...
\subsubsection{Kriminalroman}

In diesen epischen Texten geht es vor allem um Verbrechen und deren Aufklärung, meist durch einen Detektiv. Der klassische Detektiv ist intelligent und löst die Fälle durch seinen feinen Verstand. Es gibt aber auch den 'gebrochenen Detektiv', der privat Problemen hat und nur durch Zufall den Fall löst (gescheiterter Mensch) z.B. Sillenzium von Wolf Haas.

\begin{itemize}
\item Edgar Allen Poe (1841): 'Mord in der Rue Morgue' war der erste Krimi, kann man sagen
\end{itemize}

Krimiautoren:

\begin{itemize}
\item Agatha Christi: 'Miss Marple', 'Gercule Poirot' (Figur ist ein Außenseiter) - wurden schon 100te Krimis veröffentlicht
\end{itemize}
	
\newpage	
	
\section{Mittelalter (6 Jahrhundert bis 1492)}	

Es herrscht das Lehenswesen und der Klärus ist für die Bildung zuständig. 12 bis 13 Jahrhundert ist die Blütezeit des Rittertums. Nur die wenigsten konnten schreiben (Mönche, Adelige, ...). Baustile: Gotik (Spitz, Hoch, oft auch Farbig, große Fenster), Romanik (Rundbögen, kleine Fenster, massive Mauern). Gaukler waren die ersten Massenmedien und verbreiteten Lieder, Sagen und Geschichten z.B. Nibelungenlied. Schriften wurden kunstvoll von Mönchen gefertigt.
...
Übersetzt bedeutet Humanismus Menschlichkeit und orientiert sich an der Würde und den Werten des einzelnen Menschens. Grundsätze sind Toleranz, Gewaltfreiheit und Gewissensfreiheit. Die Fragen mit denen sich der Humanismus befasst: Was ist der Mensch und was ist sein wahres Wesen. Der Humanismus läuft parallel zur Aufklärung.
...
Voltaire war einer der einflussreichsten französischen Aufklärer dieser Zeit. Er war ein vielseitiger Autor und Denker.
...
\begin{itemize}
\item \underline{Christoph Gottsched}: Gottsched wollte das das deutsche Drama sich nach dem französischen Drama richtete, da das englische Drama nach Shakespeares ihn seinen Augen ein Gräuel war. Das französische Drama ist sehr streng, keinen lustigen Figuren wie der Harlekin

\item \underline{Gotthold Ephraim Lessing}: Für Lessing sollte das deutsche Theater sich nach Shakespeares richten, da er sich nicht an die strengen Regeln des Aristoteles halten wollte. Lessing verfasste die Ringparabel (=Gleichnis) 'Nathan der Weise'. Das Bürgerliche Trauerspiel ist eine Theaterform, die von Gotthold Ephraim Lessing im 18. Jahrhundert eingeführt wurde. Bis zu dieser Zeit war es nur dem Adel vorbehalten, die Hauptrollen in Theateraufführungen zu spielen. Lessing brachte dann jedoch die Geschichten und Themen der normalen Bevölkerung auf die Bühne und widersetzte sich so der damals gültigen Ständeklausel. Dies war auch als Widerstand gegen die Unterdrückung durch die Adeligen und als Kritik an der damaligen Weltordnung zu verstehen. Ein berühmtes Werk ist z.B. Emila Galotti. 
\end{itemize}
...
Die Epoche der Deutschen Klassik beginnt mit Goethes erster Italienreise 1786 und endet mit Schillers Tod 1805. Das Vorbild der Deutschen Klassik ist die Antike. Im Gegensatz zur Antike sind die Figuren nicht von Göttern abhängig, sondern treffen ihre Entscheidungen selbst. \\
