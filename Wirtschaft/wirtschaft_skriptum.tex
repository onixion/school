...
Innehabung: Man hat keinen Besitzwillen es geht ausschließlich darum die Sache zu Verwahren bzw. zu transportieren (Garderobenfrau) bzw. Paketdienst, Postbote, ... Die Sachen dürfen nicht benutzt werden.

Besitz: ist derjenige, der die Sache willentlich besitzt und nicht bereit ist sie wieder herzugeben.
...
Unterscheidung
$\rightarrow$ Innehabung - Besitz - Eigentum!
\newline
\newline
Innehabung ist die unmittelbare Verfügungsgewalt.
Besitz bedeutet, dass jemand über eine Sache verfügt, sie in seiner Gewalt hat, unabhängig ob es sein Eigentum ist.
\newline
