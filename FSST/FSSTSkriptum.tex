...
\newline
Das Ziel ist die bestmögliste Nutzung der physikalischen Maschine.
\newline
...
\item Denktopvirtualisierung: z.B. Amazon bietet mir einen virtuellen Computer.

\item Applikationsvirtualisierung: Vine (=Vine is not an emulator)
\end{itemize}
